...
INTAKE_CLASSIFICATION_SCHEMA = {
    "name": "bwc_intake_classification",
    "strict": True,
    "schema": {
        "type": "object",
        ...
        "required": [
            ...
            "procurement_intent",
            "feature_flags",
            "positive_signal_codes",
            "negative_signal_codes",
            "evidence",
            "reasoning",
            "review",
        ],
        "properties": {
            "schema_version": {
                "type": "string",
                "enum": [INTAKE_SCHEMA_VERSION],
            },
            "final_label": {
                "type": "string",
                "enum": ["BWC_RELATED", "NOT_BWC_RELATED", "UNCERTAIN"],
            },
            "is_bwc_match": {"type": "boolean"},
            ...
            "feature_flags": {
                ...
                "required": [
                    "mentions_bwc",
                    "mentions_digital_evidence",
                    "mentions_video_evidence",
                    "requests_bwc_hardware",
                    "requests_bwc_accessories",
                    "requests_docking_or_upload",
                    "requests_digital_evidence_platform",
                    "requests_video_storage",
                    "requests_redaction_or_foia_tools",
                    "requests_implementation_services",
                    "requests_maintenance_or_renewal",
                    "has_active_vendor_solicitation",
                    "has_scope_requirements",
                    "has_technical_specs",
                    "has_pricing_or_line_items",
                    "has_submission_instructions",
                    "is_policy_only",
                    "is_training_only",
                    "is_grant_or_funding_only",
                    "is_research_or_report_only",
                    "is_public_records_request_only",
                    "is_meeting_agenda_or_minutes",
                    "is_budget_line_item_only",
                    "is_adjacent_public_safety_tech",
                    "bwc_mentioned_only_in_passing",
                ],
                "properties": {
                    "mentions_bwc": {"type": "boolean"},
                    "mentions_digital_evidence": {"type": "boolean"},
                    "mentions_video_evidence": {"type": "boolean"},
                    "requests_bwc_hardware": {"type": "boolean"},
                    "requests_bwc_accessories": {"type": "boolean"},
                    "requests_docking_or_upload": {"type": "boolean"},
                    "requests_digital_evidence_platform": {"type": "boolean"},
                    "requests_video_storage": {"type": "boolean"},
                    "requests_redaction_or_foia_tools": {"type": "boolean"},
                    "requests_implementation_services": {"type": "boolean"},
                    "requests_maintenance_or_renewal": {"type": "boolean"},
                    "has_active_vendor_solicitation": {"type": "boolean"},
                    "has_scope_requirements": {"type": "boolean"},
                    "has_technical_specs": {"type": "boolean"},
                    "has_pricing_or_line_items": {"type": "boolean"},
                    "has_submission_instructions": {"type": "boolean"},
                    "is_policy_only": {"type": "boolean"},
                    "is_training_only": {"type": "boolean"},
                    "is_grant_or_funding_only": {"type": "boolean"},
                    "is_research_or_report_only": {"type": "boolean"},
                    "is_public_records_request_only": {"type": "boolean"},
                    "is_meeting_agenda_or_minutes": {"type": "boolean"},
                    "is_budget_line_item_only": {"type": "boolean"},
                    "is_adjacent_public_safety_tech": {"type": "boolean"},
                    "bwc_mentioned_only_in_passing": {"type": "boolean"},
                },
            },
            "positive_signal_codes": {
                "type": "array",
            ...
            "reasoning": {
                ...
                "properties": {
                    ...
                    "why_match_or_not": {"type": "string"},
                    "disqualifying_reason": {"type": "string"},
                },
            },
            "review": {
                "type": "object",
