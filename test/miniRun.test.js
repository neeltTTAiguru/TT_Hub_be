...
test('a mini run email says who asked for it and is marked as one in the subject', async () => {
  ...
  assert.equal(mini.subject, '1 new leads on your map - mini run - 2026-09-21')
  assert.match(mini.text, /Neel Palle asked the traveller for a few more/)
